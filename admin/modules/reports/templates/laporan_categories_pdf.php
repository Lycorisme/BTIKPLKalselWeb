...
$total_gaps = count(array_filter($mainData, function($row) { return $row['post_count'] == 0; }));
...
<body>
    ...
    <h1>Laporan Performa Kategori</h1>
    <div class="subtitle">
        Tanggal Cetak: <?= date('d F Y, H:i') ?> WIB
    </div>
    
    <h2 style="border-bottom: none; padding-bottom: 2px;">Data Agregat Kategori (Total: <?= count($mainData) ?> Data)</h2>
    <table class="data-table">
        <thead>
            <tr>
                <th style="width: 4%;">No</th>
                <th style="width: 26%;">Nama Kategori</th>
                <th style="width: 10%;">Jml Post</th>
                <th style="width: 12%;">Total Views</th>
                <th style="width: 12%;">Total Likes</th>
                <th style="width: 12%;">Total Comments</th>
                <th style="width: 12%;">Engagement</th>
                <th style="width: 12%;">Content Gap</th>
            </tr>
        </thead>
        <tbody>
            <?php if (empty($mainData)): ?>
                <tr>
                    <td colspan="8" class="text-center" style="padding: 20px;">Tidak ada data kategori</td>
                </tr>
            <?php else: ?>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-center"><?= formatNumber($total_gaps) ?></th>
            </tr>
        </tfoot>
    </table>
</body>
