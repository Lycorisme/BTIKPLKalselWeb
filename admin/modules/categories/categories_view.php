...
// Tidak perlu memuat model PostCategory karena kita akan query langsung

 $pageTitle = 'Kategori View';
...
// Direct query to get category data since PostCategory model might not have getById method
 $stmt = $db->prepare("SELECT * FROM post_categories WHERE id = ? AND deleted_at IS NULL");
    ...
    <section class="section">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="card-title mb-1">Kategori: <?= htmlspecialchars($category['name']) ?></h5>
                                <p class="text-muted mb-0">
                                    <i class="bi bi-file-text me-1"></i> <?= $totalItems ?> post dalam kategori ini
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                        <a href="categories_list.php" class="btn btn-primary w-100 w-md-auto">
        ...
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Daftar Post dalam Kategori "<?= htmlspecialchars($category['name']) ?>" (<?= $totalItems ?>)</h5>
            </div>
            <div class="card-body">
                <!-- Filter Form -->
                ...
                <?php if (empty($posts)): ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Tidak ada post dalam kategori ini yang sesuai dengan filter.</p>
                    </div>
                <?php else: ?>
