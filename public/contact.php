<?php
/**
 * Contact Page - Dynamic Version (Fixed Theme Consistency)
 * Features: Contact form, Info cards, Social media, Google Maps
    ...
    <div class="py-4 border-b border-gray-200/50">
        <div class="container mx-auto px-4">
            <nav class="flex items-center gap-2 text-sm">
                ...
                <span class="opacity-75 font-medium">Kontak</span>
            </nav>
        </div>
    </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100" data-aos="fade-up">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0 text-blue-600">
                                <i class="fas fa-map-marker-alt text-2xl"></i>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-bold mb-2 text-gray-900">Alamat</h3>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 text-green-600">
                                <i class="fas fa-phone-alt text-2xl"></i>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-bold mb-2 text-gray-900">Telepon</h3>
                                <?php 
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0 text-red-600">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow border border-gray-100" data-aos="fade-up" data-aos-delay="300">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0 text-purple-600">
                                <i class="fas fa-clock text-2xl"></i>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-lg font-bold mb-2 text-gray-900">Jam Operasional</h3>
                    ...
                    ?>
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow border border-gray-100" data-aos="fade-up" data-aos-delay="400">
                        <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-4" style="background: linear-gradient(to right, var(--color-primary), var(--color-secondary));">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-8 border border-gray-100" data-aos="fade-up">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="200">
