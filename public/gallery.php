<?php
/**
 * Gallery Page - Photo Albums (Dynamic Version)
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-12" data-aos="fade-up">
                ...
                <p class="text-gray-600 text-lg">Dokumentasi kegiatan dan acara <?= htmlspecialchars($siteName) ?></p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-12 text-center" data-aos="fade-up">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Belum Ada Album</h2>
                <p class="text-gray-600">Album galeri foto <?= htmlspecialchars($siteName) ?> akan ditampilkan di sini</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow group"
                    ...
                    <a href="?album=<?= $album['id'] ?>" class="block relative overflow-hidden">
                        ...
                        <div class="h-64 overflow-hidden bg-gray-200">
                            ...
                            <img src="<?= uploadUrl($album['cover_photo']) ?>" 
                                 ...
                                 loading="lazy"
                                 onerror="this.parentElement.innerHTML='<div class=\'w-full h-full flex items-center justify-center\'><i class=\'fas fa-image text-6xl text-gray-400\'></i></div>'">
                            <?php else: ?>
                    ...
                    <div class="p-6">
                        ...
                        <a href="?album=<?= $album['id'] ?>" 
                           class="mt-4 inline-flex items-center text-blue-600 hover:text-blue-700 font-medium transition">
                            Lihat Album
    ...
    <section class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="mb-8" data-aos="fade-up">
                <a href="<?= BASE_URL ?>gallery.php" class="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4 transition">
            ...
            <div class="bg-white rounded-lg shadow-md p-12 text-center" data-aos="fade-up">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Belum Ada Foto</h2>
                <p class="text-gray-600">Foto dalam album ini akan ditampilkan di sini</p>
            </div>
                ...
                <div class="group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
                    ...
                    <div class="aspect-square overflow-hidden bg-gray-200">
                        <img src="<?= uploadUrl($photo['thumbnail'] ?? $photo['filename']) ?>" 
                             ...
                             class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-300"
                             loading="lazy"
                             onerror="this.parentElement.innerHTML='<div class=\'w-full h-full flex items-center justify-center bg-gray-200\'><i class=\'fas fa-image text-4xl text-gray-400\'></i></div>'">
                    </div>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4 text-white opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <p class="text-xs mt-1 line-clamp-2"><?= htmlspecialchars($photo['caption']) ?></p>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-12 flex justify-center" data-aos="fade-up">
                <nav class="flex gap-2">
                    ...
                    <span class="px-4 py-2">...</span>
                    <?php endif; ?>
                    <a href="?album=<?= $album_id ?>&page=<?= $total_pages ?>" 
                       class="px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                        <?= $total_pages ?>
                    </a>
                    <?php endif; ?>
